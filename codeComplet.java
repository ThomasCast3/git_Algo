...
public class test {
        ...
        public  static  void stat(int min, int max, int step, int nbr)
        {
            ...
            for (int i = min; i <= max; i += step)
            {
                for (int j = 0; j < nbr; j++)
                {
                   ...
                   //  operationArray[j] = triSelection( tableau);
                  // operationArray[j] =  triInsertion( tableau);
                    operationArray[j] =  triBulleOpti(tableau);
                  //  operationArray[j] =  triBullNorm(tableau);
                }
        ...
        public  static int[] tableauAleatoire(int i)
        {
            ...
            for (int j=0; j<i; j++) {
                tableau[j] = random.nextInt(100 - 0) + 0;
            }
        ...
        public  static int triSelection(int [] tableau) {
           ...
           // for (int x : tableau) {
           //     System.out.print(x + " "); //Affichage du tableau trié
      ...
      //      System.out.println("Affectations : " + affectation);
       //     System.out.println("Comparaisons : " + comparaison);
        ...
        public  static  int  triBulleOpti(int [] tableau)
        {
        ...
        public  static void triBullNorm(int [] tableau)
        {
